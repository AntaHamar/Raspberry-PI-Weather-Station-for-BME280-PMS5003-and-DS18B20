...
class WeatherApp:
    def __init__(self, root):
        ...
        self.themes = {
            "standard": {"bg": "
                         "header": "white"},
            "contrast": {"bg": "black", "pill": "white", "text_main": "black", "text_label": "
                         "header": "yellow"}
        }
        ...
        tk.Checkbutton(tool_frame, text="Voice (V)", variable=self.speech_enabled,
                       bg=self.current_theme["bg"], fg="white", selectcolor="
        ...
        self.speak_btn = tk.Button(self.main_frame, text="🔊 READ ALOUD (SPACE)",
                                   ...
                                   bg="
        self.speak_btn.pack(pady=20, fill="value", padx=50)
    ...
    def update_loop(self):
        ...
        for s in self.status_dots:
            self.status_canvases[s].itemconfig(self.status_dots[s], fill="
        ...
        updates = [
            ...
            ("pm25", f"💨 {pm} µg/peak³", "red" if pm > 35 else self.current_theme["text_main"]),
